...
from ...DshellParser.ast_nodes import StrNode, IntNode

async def utils_get_thread(ctx: Message, thread: Union[IntNode, StrNode]) -> Union[Thread, None]:
    """
